...
def main():
    ...
    sdf_file_path = os.path.join(model_dir, "cart", "model.sdf")
    print(sdf_file_path)
    ...
    request.xml = re.sub('TorusCart_red_darkblue.dae', mesh_name, request.xml)
    ...
    request.initial_pose.orientation.z = float(argv[6])
    print(request.initial_pose)
